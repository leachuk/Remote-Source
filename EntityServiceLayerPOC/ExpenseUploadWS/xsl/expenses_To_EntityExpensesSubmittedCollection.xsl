...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.5.0(build 110418.1550.0174) AT [MON MAY 27 10:29:42 EST 2013]. -->
?>
  ...
  <xsl:template match="/">
    <top:EntityExpensesSubmittedCollection>
      <top:EntityExpensesSubmitted>
        <top:userId>
          <xsl:text disable-output-escaping="no">testuser1</xsl:text>
        </top:userId>
        <top:amount>
